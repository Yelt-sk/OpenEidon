...
impl PyMessage {
    pub fn to_core(&self) -> openeidon_core::Message {
        let role = match self.role.as_str() {
            "system" => openeidon_core::Role::System,
            "assistant" => openeidon_core::Role::Assistant,
            "tool" => openeidon_core::Role::Tool,
            _ => openeidon_core::Role::User,
        };
        openeidon_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: openeidon_core::EidonConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: openeidon_core::EidonConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<openeidon_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(openeidon_core::EventBus::new(true)),
        }
    }
