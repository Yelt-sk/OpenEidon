...
use openeidon_core::OpenEidonError;
...
impl AuditLogger {
    ...
    pub fn log(&self, event: &SecurityEvent) -> Result<(), OpenEidonError> {
    ...
    pub fn verify_chain(&self) -> Result<(bool, Option<i64>), OpenEidonError> {
        let mut stmt = self
            .conn
            .prepare(
    ...
    pub fn query(
        ...
        since: Option<f64>,
        limit: usize,
    ) -> Result<Vec<SecurityEvent>, OpenEidonError> {
