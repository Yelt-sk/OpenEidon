...
use openeidon_core::error::OpenEidonError;
use openeidon_core::{EventBus, EventType, GenerateResult, Message};
use openeidon_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(OpenEidonError::Security(
                    openeidon_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, OpenEidonError::Security(_)));
    }
}
