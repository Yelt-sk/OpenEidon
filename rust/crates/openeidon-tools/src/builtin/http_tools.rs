...
use openeidon_core::{OpenEidonError, ToolResult, ToolSpec};
use openeidon_security::ssrf::check_ssrf;
...
impl BaseTool for HttpRequestTool {
    ...
    fn execute(&self, params: &Value) -> Result<ToolResult, OpenEidonError> {
