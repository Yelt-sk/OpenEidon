...
use openeidon_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, openeidon_core::OpenEidonError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, openeidon_core::OpenEidonError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, openeidon_core::OpenEidonError>;

    fn list_models(&self) -> Result<Vec<String>, openeidon_core::OpenEidonError>;
...
mod tests {
    use super::*;
    use openeidon_core::{Message, ToolCall};
