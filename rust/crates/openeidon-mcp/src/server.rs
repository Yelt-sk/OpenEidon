...
mod tests {
    use super::*;
    use openeidon_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(openeidon_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
