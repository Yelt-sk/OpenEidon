...
Route queries to the cheapest capable model using OpenEidon's learning/routing
...
The script uses OpenEidon's routing infrastructure from the learning pillar:
