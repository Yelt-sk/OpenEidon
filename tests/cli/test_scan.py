"""Tests for ``eidon scan`` privacy scanner CLI command."""
...
from openeidon.cli.scan_cmd import PrivacyScanner, ScanResult
...
class TestJsonOutput:
    ...
    def test_json_output_structure(self) -> None:
        ...
        runner = CliRunner()
        with patch(
            "openeidon.cli.scan_cmd.PrivacyScanner.run_all",
            return_value=[
