"""Tests for the ``eidon registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the eidon registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "openeidon.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"openeidon.core.registry": None}):
