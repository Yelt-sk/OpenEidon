...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "openeidon.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        with patch.object(EidonSystem, "_run_agent", patched_run_agent):
            real_system = EidonSystem(
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from openeidon.core.config import OperatorsConfig
    ...
    def test_config_in_eidon_config(self):
        from openeidon.core.config import EidonConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "openeidon" / "operators" / "data"
