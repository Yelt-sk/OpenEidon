...
from openeidon.speech.tts import TTSResult
...
def test_cartesia_registered():
    from openeidon.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "openeidon.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from openeidon.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from openeidon.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "openeidon.speech.openai_tts._openai_tts_request",
