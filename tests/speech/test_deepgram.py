...
from openeidon.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("openeidon.speech.deepgram.DeepgramClient", return_value=mock_client):
        from openeidon.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("openeidon.speech.deepgram.DeepgramClient"):
        from openeidon.speech.deepgram import DeepgramSpeechBackend
