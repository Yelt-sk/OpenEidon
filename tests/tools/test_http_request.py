...
def _force_httpx_fallback():
    ...
    with patch(
        "openeidon._rust_bridge.get_rust_module",
...
class TestHttpRequestTool:
    ...
    def test_ssrf_blocked_private_ip(self):
        ...
        tool = HttpRequestTool()
        with patch("openeidon.tools.http_request.check_ssrf") as mock_ssrf:
    ...
    def test_successful_get(self):
        ...
        tool = HttpRequestTool()
        with patch("openeidon.tools.http_request.check_ssrf", return_value=None):
    ...
    def test_timeout_handling(self):
        ...
        with patch("openeidon.tools.http_request.check_ssrf", return_value=None):
            with patch(
                "openeidon.tools.http_request.httpx.request",
