...
from openeidon.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        ...
        sys.modules.pop("openeidon.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "OPENEIDON_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "OPENEIDON_TEST_PASSTHROUGH_67890"
