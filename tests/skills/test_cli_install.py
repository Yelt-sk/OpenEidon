...
class TestCliInstallE2E:
    def test_install_hermes_skill_e2e(self, tmp_path: Path) -> None:
        """eidon skill install hermes:research-skill installs to target dir."""
        ...
        with patch(
            "openeidon.cli.skill_cmd._get_resolver",
            ...
            with patch.object(HermesResolver, "sync", lambda self: None):
                ...
                # ~/.openeidon/skills/.
                from openeidon.skills.importer import SkillImporter as _SI
