...
class TestDefaults:
    def test_eidon_config_defaults(self) -> None:
        cfg = EidonConfig()
...
class TestTomlLoading:
    def test_load_missing_file_uses_defaults(self, tmp_path: Path) -> None:
        ...
        assert isinstance(cfg, EidonConfig)
...
class TestSecurityConfig:
    ...
    def test_security_config_on_eidon_config(self) -> None:
        cfg = EidonConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_eidon_config(self) -> None:
        cfg = EidonConfig()
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "openeidon-sandbox:latest"
    ...
    def test_on_eidon_config(self) -> None:
        cfg = EidonConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from openeidon.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from openeidon.core.config import _apply_toml_section
...
class TestWhatsAppBaileysChannelConfig:
    def test_defaults(self) -> None:
        ...
        assert wc.auth_dir == ""
        assert wc.assistant_name == "Eidon"
