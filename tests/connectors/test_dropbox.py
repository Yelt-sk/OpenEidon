...
def connector(tmp_path: Path):
    ...
    from openeidon.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("openeidon.connectors.dropbox._dropbox_api_list_folder")
@patch("openeidon.connectors.dropbox._dropbox_api_download")
