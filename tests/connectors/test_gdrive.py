...
def connector(tmp_path: Path):
    ...
    from openeidon.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("openeidon.connectors.gdrive._gdrive_api_list_files")
@patch("openeidon.connectors.gdrive._gdrive_api_export")
