...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from openeidon.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from openeidon.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from openeidon.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from openeidon.connectors.google_tasks import GoogleTasksConnector
