...
_LOCAL_CONNECTORS = [
    ("apple_notes", "openeidon.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "openeidon.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "openeidon.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "openeidon.connectors.outlook", "OutlookConnector"),
    ("slack", "openeidon.connectors.slack_connector", "SlackConnector"),
    ("notion", "openeidon.connectors.notion", "NotionConnector"),
    ("granola", "openeidon.connectors.granola", "GranolaConnector"),
    ("gdrive", "openeidon.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "openeidon.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "openeidon.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "openeidon.connectors.dropbox", "DropboxConnector"),
]
