...
def connector(tmp_path: Path):
    ...
    from openeidon.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("openeidon.connectors.notion._notion_api_search")
@patch("openeidon.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from openeidon.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415
