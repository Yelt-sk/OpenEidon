...
def test_hackernews_registered():
    ...
    from openeidon.connectors.hackernews import HackerNewsConnector
...
def test_sync_yields_top_five(connector):
    ...
    with (
        patch(
            "openeidon.connectors.hackernews._hn_top_story_ids",
            return_value=_TOP_STORY_IDS,
        ),
        patch(
            "openeidon.connectors.hackernews._hn_item",
