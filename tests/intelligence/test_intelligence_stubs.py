...
class TestBackwardCompatShims:
    ...
    def test_router_policy_from_intelligence(self) -> None:
        from openeidon.intelligence._stubs import RouterPolicy

        with pytest.raises(TypeError):
            RouterPolicy()  # type: ignore[abstract]

    def test_query_analyzer_from_intelligence(self) -> None:
        from openeidon.intelligence._stubs import QueryAnalyzer

        with pytest.raises(TypeError):
            QueryAnalyzer()  # type: ignore[abstract]

    def test_same_class_as_learning(self) -> None:
        from openeidon.intelligence._stubs import QueryAnalyzer as IQA
        from openeidon.intelligence._stubs import RouterPolicy as IRP
        from openeidon.learning._stubs import QueryAnalyzer as LQA
        from openeidon.learning._stubs import RouterPolicy as LRP
...
class TestRoutingContextInCoreTypes:
    ...
    def test_import_from_core_types(self) -> None:
        from openeidon.core.types import RoutingContext as RC
    ...
    def test_backward_compat_import(self) -> None:
        from openeidon.learning._stubs import RoutingContext as RC
    ...
    def test_router_policy_backward_compat(self) -> None:
        from openeidon.intelligence._stubs import RouterPolicy
        from openeidon.learning._stubs import RouterPolicy as RP
