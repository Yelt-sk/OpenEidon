"""Tests for EidonAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestEidonAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(EidonAgentBackend.__init__)
