...
- EidonDirectBackend propagates gpu_metrics flag
...
from openeidon.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from openeidon.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from openeidon.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# EidonDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify EidonDirectBackend sets gpu_metrics on config."""

    @patch("openeidon.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("openeidon.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from openeidon.evals.core.config import expand_suite
        from openeidon.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
