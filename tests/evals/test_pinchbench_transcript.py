...
from openeidon.evals.core.event_recorder import AgentEvent, EventType
from openeidon.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from openeidon.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """OpenEidon tool names are mapped to PinchBench-expected names."""
    from openeidon.evals.scorers.pinchbench import events_to_transcript
