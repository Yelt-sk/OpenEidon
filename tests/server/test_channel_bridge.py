...
pytest.importorskip("fastapi", reason="openeidon[server] not installed")

from openeidon.channels._stubs import (
    BaseChannel,
    ChannelHandler,
    ChannelStatus,
)
...
def mock_system():
    system = MagicMock()
    system.ask.return_value = {"content": "Hello from Eidon!"}
    return system
