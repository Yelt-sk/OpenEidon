...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("openeidon.mcp.transport.StreamableHTTPTransport"),
        patch("openeidon.mcp.client.MCPClient"),
        patch("openeidon.tools.mcp_adapter.MCPToolProvider") as MockProvider,
    ):
