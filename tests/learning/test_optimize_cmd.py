"""Smoke tests for ``eidon optimize`` and ``eidon feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in EidonConfig."""

    def test_optimize_config_in_eidon_config(self):
        from openeidon.core.config import EidonConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from openeidon.core.config import OptimizeConfig
