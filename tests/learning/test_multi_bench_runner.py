...
from openeidon.optimize.trial_runner import BenchmarkSpec, MultiBenchTrialRunner
...
class TestMultiBenchRunTrial:
    @patch("openeidon.optimize.trial_runner.TrialRunner.run_trial")
...
class TestLoadBenchmarkSpecs:
    def test_multi_benchmark_format(self):
        from openeidon.optimize.config import load_benchmark_specs
...
class TestParamToRecipe:
    def test_max_tokens_mapping(self):
        from openeidon.optimize.types import _PARAM_TO_RECIPE
