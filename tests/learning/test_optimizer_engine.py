"""Tests for openeidon.optimize.optimizer module."""
...
from openeidon.optimize.optimizer import OptimizationEngine
...
class TestLoadOptimizeConfig:
    ...
    def test_loads_toml_file(self, tmp_path) -> None:
        from openeidon.optimize.config import load_optimize_config
