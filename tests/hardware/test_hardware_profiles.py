...
class TestDetectHardware:
    ...
    @patch("openeidon.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "openeidon.core.config._run_cmd",
    ...
    @patch("openeidon.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "openeidon.core.config._run_cmd",
        side_effect=[
    ...
    @patch("openeidon.core.config.platform.system", return_value="Darwin")
    @patch(
        "openeidon.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("openeidon.core.config.shutil.which", return_value=None)
    @patch("openeidon.core.config.platform.system", return_value="Linux")
