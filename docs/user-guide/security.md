...
OpenEidon includes a security layer that scans prompts and model outputs for secrets, personally identifiable information (PII), and sensitive file paths. The system is designed to be composable: scanners run as a pipeline, and the `GuardrailsEngine` wrapper drops in front of any inference backend without changing how the rest of your code works.
...
=== "Warn mode (default)"
    ...
    from openeidon.security.types import RedactionMode
...
=== "Block mode"
    ...
    from openeidon.engine.ollama import OllamaEngine
    from openeidon.security.guardrails import GuardrailsEngine, SecurityBlockError
    from openeidon.security.types import RedactionMode
    from openeidon.core.types import Message, Role
...
from openeidon.security.scanner import PIIScanner
...
from openeidon.security.file_policy import is_sensitive_file, filter_sensitive_paths
...
from openeidon.security.audit import AuditLogger
from openeidon.security.guardrails import GuardrailsEngine
from openeidon.security.types import RedactionMode
from openeidon.engine.ollama import OllamaEngine
...
audit = AuditLogger(db_path="~/.openeidon/audit.db", bus=bus)
...
import time
from openeidon.security.audit import AuditLogger
from openeidon.security.types import SecurityEvent, SecurityEventType
...
audit = AuditLogger(db_path="~/.openeidon/audit.db")
...
Security settings live in the `[security]` section of `~/.openeidon/config.toml`.
...
secret_scanner = true
pii_scanner = true
audit_log_path = "~/.openeidon/audit.db"
...
| `audit_log_path` | `str` | `~/.openeidon/audit.db` | Path to the SQLite audit log |
...
import re
from openeidon.security._stubs import BaseScanner
from openeidon.security.types import ScanFinding, ScanResult, ThreatLevel
...
- [API Reference: Security](../api-reference/openeidon/security/index.md) — full class and function signatures
