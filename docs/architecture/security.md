...
The default path is `~/.openeidon/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/openeidon/security/index.md) — complete class and function signatures
