...
const OPTIN_KEY = 'openeidon-desktop-optin';
const OPTIN_NAME_KEY = 'openeidon-desktop-display-name';
const OPTIN_EMAIL_KEY = 'openeidon-desktop-email';
const OPTIN_ANONID_KEY = 'openeidon-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://yelt-sk.github.io/OpenEidon/leaderboard"
            target="_blank"
