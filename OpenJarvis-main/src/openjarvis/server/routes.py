...
async def get_user_preferences():
    ...
    from openjarvis.tools.preferences_tool import _load
    return _load()
...
async def update_user_preferences(category: str, request: Request):
    ...
    from openjarvis.tools.preferences_tool import _load, _save, PREFS_PATH
    try:
...
FILE_ROOTS_CONFIG = Path(r"D:\projects\jarvis\.jarvis-file-roots.json")
...
CHECKIN_SETTINGS_FILE = Path(r"D:\projects\Jarvis\.jarvis-checkin.json")
