...
``~/.openeidon/learning/skills/<skill-name>/optimized.toml``.
...
from openeidon.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from openeidon.core.config import DSPyOptimizerConfig
        from openeidon.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from openeidon.learning.agents.gepa_optimizer import GEPAAgentOptimizer
