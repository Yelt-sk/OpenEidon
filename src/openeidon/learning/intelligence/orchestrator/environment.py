...
Adapted from IPW's ``environment.py``.  Uses OpenEidon's
:class:`~openeidon.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via OpenEidon ``ToolExecutor``.
