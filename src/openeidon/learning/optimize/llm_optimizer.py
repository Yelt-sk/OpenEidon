"""LLM-based optimizer for OpenEidon configuration tuning.

Uses a cloud LLM to propose optimal OpenEidon configs, inspired by DSPy's
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal OpenEidon configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an OpenEidon AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this OpenEidon evaluation result.")
        lines.append("")
