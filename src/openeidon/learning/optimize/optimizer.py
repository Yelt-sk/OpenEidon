...
from openeidon.learning.optimize.trial_runner import TrialRunner
...
class OptimizationEngine:
    ...
    def run(
        ...
        from openeidon.learning.optimize.trial_runner import MultiBenchTrialRunner
        ...
        for trial_num in range(1, self.max_trials + 1):
            ...
            if result.summary is not None:
                ...
                from openeidon.evals.core.types import RunSummary as _RS
