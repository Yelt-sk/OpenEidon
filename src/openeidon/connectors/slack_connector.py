...
Uses OAuth tokens stored locally (see :mod:`openeidon.connectors.oauth`).
...
from openeidon.connectors.oauth import delete_tokens, load_tokens, save_tokens
...
class SlackConnector(BaseConnector):
    ...
    credentials_path:
        ...
        ``~/.openeidon/connectors/slack.json``.
    """
