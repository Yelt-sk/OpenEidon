...
def _user_templates_dir() -> Path:
    """Return the path to user-defined templates (~/.openeidon/templates/agents/)."""
    return Path.home() / ".openeidon" / "templates" / "agents"
...
def discover_templates(
    ...
    2. User templates at ``~/.openeidon/templates/agents/``.
