...
<title>OpenEidon — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>OpenEidon</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      OpenEidon runs models on your own hardware. Every inference call that would
  ...
  <div class="calc-section">
    ...
    <div class="calc-results">
      <div class="calc-card free">
        <div class="cc-label">OpenEidon</div>
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install OpenEidon and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/Yelt-sk/OpenEidon.git
&& cd OpenEidon && uv sync</code>
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/open-eidon/'
    + 'OpenEidon.git && cd OpenEidon && uv sync';
