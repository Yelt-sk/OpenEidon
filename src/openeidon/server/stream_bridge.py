...
from openeidon.agents._stubs import AgentContext, BaseAgent
from openeidon.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("openeidon.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from openeidon.core.types import Message as MsgType
                    from openeidon.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("openeidon.server")
                    _logger.warning(
