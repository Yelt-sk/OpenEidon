...
from openeidon.security.file_policy import (
    DEFAULT_SENSITIVE_PATTERNS,
    filter_sensitive_paths,
    is_sensitive_file,
)
from openeidon.security.guardrails import GuardrailsEngine, SecurityBlockError
from openeidon.security.scanner import PIIScanner, SecretScanner
from openeidon.security.ssrf import check_ssrf, is_private_ip
...
def setup_security(
    ...
    if config.security.capabilities.enabled:
        try:
            from openeidon.security.capabilities import CapabilityPolicy
