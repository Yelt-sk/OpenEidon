"""SkillImporter — install ResolvedSkill instances into ~/.openeidon/skills/.
...
from openeidon.skills.sources.base import ResolvedSkill
...
class SkillImporter:
    ...
    def __init__(
        ...
        if target_root is None:
            target_root = Path("~/.openeidon/skills/").expanduser()
