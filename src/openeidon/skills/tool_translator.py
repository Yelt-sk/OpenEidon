"""ToolTranslator — translate external tool names to OpenEidon equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  OpenEidon uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → OpenEidon name
# ---------------------------------------------------------------------------
