...
from openeidon.agents._stubs import AgentContext, AgentResult, BaseAgent
...
_OUTPUT_START = "---OPENEIDON_OUTPUT_START---"
_OUTPUT_END = "---OPENEIDON_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``openeidon-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "openeidon-sandbox:latest"
    DEFAULT_TIMEOUT = 300
