...
class SaveMarkdownNoteTool(BaseTool):
    ...
    def spec(self) -> ToolSpec:
        return ToolSpec(
            ...
            description=(
                "Save a markdown note into the Eidon/markdown folder. "
...
class ListMarkdownNotesTool(BaseTool):
    ...
    def spec(self) -> ToolSpec:
        return ToolSpec(
            ...
            description="List markdown notes stored in the Eidon/markdown folder.",
...
class ReadMarkdownNoteTool(BaseTool):
    ...
    def spec(self) -> ToolSpec:
        return ToolSpec(
            ...
            description="Read a markdown note from the Eidon/markdown folder by filename.",
            parameters={
                "type": "object",
                "properties": {
