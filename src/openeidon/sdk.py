"""High-level Python SDK for OpenEidon."""
...
from openeidon.system import EidonSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: EidonConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        import openeidon.tools.storage  # noqa: F401
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from openeidon.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from openeidon.tools.storage.chunking import ChunkConfig
        from openeidon.tools.storage.ingest import ingest_path
...
class Eidon:
    ...
    @property
    def config(self) -> EidonConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the OpenEidon version string."""
        return openeidon.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import openeidon.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        import openeidon.agents  # noqa: F401
        ...
        if tools:
            ...
            from openeidon.cli.ask import _build_tools
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from openeidon.cli.ask import _get_memory_backend
...
__all__ = ["Eidon", "EidonSystem", "MemoryHandle", "SystemBuilder"]
