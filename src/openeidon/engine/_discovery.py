...
def _make_engine(key: str, config: EidonConfig) -> InferenceEngine:
...
def discover_engines(config: EidonConfig) -> List[Tuple[str, InferenceEngine]]:
...
def get_engine(
    config: EidonConfig, engine_key: str | None = None
