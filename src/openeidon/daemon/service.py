...
SYSTEMD_TEMPLATE = """\
[Unit]
Description=OpenEidon Gateway Daemon
After=network.target

[Service]
Type=simple
ExecStart={python} -m openeidon.daemon.gateway
Restart=on-failure
RestartSec=5
...
<dict>
    <key>Label</key>
    <string>com.openeidon.gateway</string>
    <key>ProgramArguments</key>
    <array>
        <string>{python}</string>
        <string>-m</string>
        <string>openeidon.daemon.gateway</string>
    </array>
    <key>RunAtLoad</key>
    <true/>
    <key>KeepAlive</key>
