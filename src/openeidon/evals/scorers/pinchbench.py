...
Provides transcript translation (OpenEidon events → PinchBench format),
...
from openeidon.evals.core.event_recorder import EventType
from openeidon.evals.core.scorer import LLMJudgeScorer
from openeidon.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: OpenEidon name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from EidonAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
