...
from openeidon.evals.core.export import _hardware_info_dict
from openeidon.evals.core.scorer import Scorer
from openeidon.evals.core.tracker import ResultTracker
...
try:
    from openeidon.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from openeidon.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from openeidon.evals.core.dataset import DatasetProvider as _DP
