"""``eidon ask`` — send a query to the assistant."""
...
from openeidon.cli._tool_names import resolve_tool_names
from openeidon.cli.hints import hint_no_engine
...
def ask(
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]eidon config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
