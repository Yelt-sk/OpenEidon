"""Global logging configuration for the OpenEidon CLI."""
...
from openeidon.security.credential_stripper import CredentialStripper
...
def setup_logging(
    ...
    """Configure the ``openeidon`` logger.
    ...
    Returns
    -------
    The configured ``openeidon`` logger.
    """
    logger = logging.getLogger("openeidon")
