"""``eidon chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from openeidon.engine import get_engine
    from openeidon.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import openeidon.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]OpenEidon Chat[/green bold]\n"
