...
from openeidon.mcp.protocol import MCPError, MCPRequest, MCPResponse
from openeidon.mcp.transport import MCPTransport
...
class MCPClient:
    ...
    def initialize(self) -> Dict[str, Any]:
        ...
        params = {
            ...
            "capabilities": {},
            "clientInfo": {"name": "openeidon", "version": "0.1.0"},
        }
