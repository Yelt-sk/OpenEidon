...
from openeidon.core.types import Message, Role, ToolCall, ToolResult
...
def _build_system_prompt() -> str:
    ...
    return f"""\
/no_think
You are Eidon, a personal AI assistant with access to the user's private \
...
"what do I know about OpenEidon?". Search a topic across ALL sources \
