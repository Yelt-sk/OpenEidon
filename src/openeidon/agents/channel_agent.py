...
Routes incoming :class:`~openeidon.channels._stubs.ChannelMessage` objects
...
from openeidon.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in OpenEidon:\nopeneidon://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~openeidon.agents._stubs.BaseAgent`
        subclass).
    max_workers:
